...
$path_testimonialswidget = get_template_directory() . '/includes/widgets/klasik-testimonials-widget.php';
if(file_exists($path_testimonialswidget)) include_once ($path_testimonialswidget);

$path_sponsorswidget = get_template_directory() . '/includes/widgets/klasik-sponsors-widget.php';
if(file_exists($path_sponsorswidget)) include_once ($path_sponsorswidget);
...
function klasik_theme_widgets() {
	...
	register_widget("Klasik_TestimonialsWidget");
	...
	register_widget("Klasik_SponsorsWidget");
	register_widget("Klasik_TestimonialsWidget");
