...
class Klasik_TestimonialsWidget extends WP_Widget {
    /** constructor */

	function Klasik_TestimonialsWidget() {
		$widget_ops = array('classname' => 'widget_klasik_testimonials', 'description' => __('KlasikThemes Testimonials','klasik') );
		$this->WP_Widget('klasik-testimonials-widget', __('KlasikThemes Testimonials','klasik'), $widget_ops);
	}
    ...
    function widget($args, $instance) {		
		...
		if(!is_numeric($cols) || $cols < 1 || $cols > 6){
			$cols = 4;
					...
					$output .='<div class="klasik-testimonials-widget '.$customclass.'">';
						$output .='<div class="row">';
							...
							if ($wp_query->have_posts()) : 
								...
								$cf_thumb = get_the_post_thumbnail($post->ID, 'widget-testimonials', array('class' => 'alignleft'));
